...
def ALEX_NET_1(x):
    ...
    # 첫번째 Pooling layer
    # MAX_POOL_01 = tf.nn.max_pool(h_conv1, ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1], padding='SAME')
...
with tf.Session() as sess:
    ...
    for i in range(N_EPISODES):
        ...
        if (i+1) % 100 == 0:
            ...
            print("Epoch: %6d, Training Accuracy: %2.6f, Loss: %2.6f" % (i+1, train_accuracy, loss_print))
